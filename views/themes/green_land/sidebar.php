			...
			<div class="card-body">
				...
				<?php $options = get_answers($query->id); foreach($options->result() as $option) { ?>
					<div class="form-check">
						<div class="dot"></div>
						<input class="form-check-inputl input-radio" type="radio" name="answer_id" id="answer_id_<?=$option->id?>" value="<?=$option->id?>">
